...
After successful installation of MoBIE (see [main readme](../README.md)) you can open a CebraEM/MoBIE project using ```Fiji -> Plugins -> MoBIE -> Open -> Open Collection Table...```
